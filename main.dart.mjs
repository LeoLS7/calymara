...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      LJ: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      LK: x0 => x0.repeat,
      M: o => String(o),
      MB: (o, p) => o[p],
      ...
      MH: x0 => x0.status,
      MI: (a, i) => a.splice(i, 1),
      MJ: (x0,x1) => globalThis.fetch(x0,x1),
      ...
      OJ: (wasmFunction,f) => finalizeWrapper(f, function(x0,x1,x2) { return wasmFunction(f,arguments.length,x0,x1,x2) }),
      ...
      QI: x0 => x0.createBufferSource(),
      QJ: x0 => x0.name,
      QK: (x0,x1) => x0.getItem(x1),
      ...
      WH: x0 => x0.current(),
      WI: (x0,x1) => { x0.buffer = x1 },
      WJ: x0 => x0.read(),
      WK: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      X: o => [o],
      XB: (t, s) => t.set(s),
      XC: x0 => x0.userAgent,
      XD: x0 => x0.shiftKey,
      ...
      aI: (x0,x1,x2,x3) => x0.createBuffer(x1,x2,x3),
      aJ: x0 => x0.headers,
      aK: x0 => x0.play(),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      ...
      cE: x0 => x0.scrollTop,
      cF: () => typeof dartUseDateNowForTicks !== "undefined",
      cG: x0 => x0.selectionEnd,
      cH: x0 => x0.next(),
      cI: x0 => x0.resume(),
      cJ: (x0,x1) => x0.getRandomValues(x1),
      cK: (x0,x1) => x0.createMediaElementSource(x1),
      d: (o, p) => o[p],
      ...
      dE: x0 => x0.offsetTop,
      dF: () => 1000 * performance.now(),
      dG: x0 => x0.keyCode,
      dH: x0 => x0.value,
      dI: x0 => x0.destination,
      dJ: () => globalThis.crypto,
      dK: x0 => x0.createStereoPanner(),
      e: () => globalThis,
      eB: o => {
        if (o === null || o === undefined) return 0;
      ...
      hI: (x0,x1,x2) => x0.insertRule(x1,x2),
      hJ: () => globalThis.navigator.audioSession,
      hK: x0 => x0.error,
      i: (l, r) => l === r,
      ...
      kD: x0 => x0.language,
      kE: x0 => x0.deltaX,
      kF: (a, i) => a.splice(i, 1)[0],
      kG: (x0,x1) => { x0.name = x1 },
      kH: x0 => x0.buffer,
      kI: (x0,x1,x2) => x0.addEventListener(x1,x2),
      kJ: (x0,x1) => x0.decodeAudioData(x1),
      kK: (x0,x1) => { x0.playbackRate = x1 },
      l: o => {
        if (o === undefined || o === null) return 0;
      ...
      nG: (x0,x1) => { x0.name = x1 },
      nH: () => new TextDecoder(),
      nI: (x0,x1) => x0.selectNode(x1),
      nJ: (x0,x1) => ({capture: x0,passive: x1}),
      nK: (x0,x1) => { x0.preload = x1 },
